import {
  ...
  ShaderChunk,
  ShaderLib
} from "./chunk-ZYSCGPI6.js";
import "./chunk-BUSYA2B4.js";

// node_modules/three-hex-tiling/dist/index.js
...
var C = () => {
  ...
  ), ShaderChunk.metalnessmap_fragment = l(
  ...
  ), ShaderChunk.tilebreaking_pars_fragment = x;
};
var c = (e) => {
  h || (h = true, C());
  let n = e;
...
var M = () => {
  const e = ShaderLib.standard.fragmentShader, n = c(e);
  ShaderLib.standard.fragmentShader = n, Object.assign(ShaderLib.standard.uniforms, p()), d(MeshStandardMaterial);
};
var b = () => {
  const e = ShaderLib.physical.fragmentShader, n = c(e);
  ShaderLib.physical.fragmentShader = n, Object.assign(ShaderLib.physical.uniforms, p()), d(MeshPhysicalMaterial);
};
b();
M();
//# sourceMappingURL=three-hex-tiling.js.map
