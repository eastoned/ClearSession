...
export const cameraMain = new THREE.PerspectiveCamera(50, window.innerWidth/window.innerHeight, 0.1, 10000);
...
export function moveCam(xPos, yPos, zPos, offsetX = 0, offsetY = 0, offsetZ = 70) {
        ...
        cameraControls.setLookAt(xPos + offsetX + 5, yPos + offsetY, zPos + offsetZ-5, xPos + 5, yPos, 12, true);
